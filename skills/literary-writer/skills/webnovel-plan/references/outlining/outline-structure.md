...
> **特鲁比步骤标注说明**：每卷可视为一个独立的"微型故事"，标注该卷对应特鲁比 22 步中的哪些关键节点，有助于检验每卷的叙事完整性。
> 详见 `references/screenplay/truby-22-steps.md` 第五节"22 步与网文分卷映射"。
...
**特鲁比步骤**:
  - 卷内虚假自我: 被退婚的废材（步骤1）
  - 卷内欲望: 变强，打脸前未婚妻（步骤2）
  - 卷内对手: 叶良辰——天才型，代表主角失去的一切（步骤3）
  - 卷内计划: 获得系统→苦修→宗门大比（步骤4）
  - 卷内盟友: 师兄/灵宠——弥补主角经验不足（步骤12）
  - 卷内表面失败: 被逐出家族，失去一切（步骤15）
  - 卷内对决: 宗门大比终极战斗（步骤19）
  - 卷内新平衡: 成为宗门新星，获得进入更大舞台的资格（步骤22）
...
**特鲁比步骤**:
  - 卷内幽灵: 发现父亲留下的秘密（步骤8）
  - 卷内新欲望: 找到妹妹的下落（步骤2/11）
  - 卷内对手: 宗门内的阴谋家——代表体制之恶（步骤3/13）
  - 卷内表面失败: 师尊被杀，宗门分裂（步骤15）
  - 卷内第二次揭示: 理解"力量不只是个人修为"（步骤16）
  - 卷内新平衡: 获得关键线索，踏上救妹之路（步骤22）
...
**特鲁比步骤**:
  - 卷内对手升级: 血神教主——代表主角可能走向的黑暗面（步骤3/13）
  - 卷内表面失败: 战败，妹妹未能救出（步骤15）
  - 卷内第二次揭示: 理解对手的世界观（步骤16）
  - 卷内第三次揭示与抉择: 做出关键的道德选择（步骤17）
  - 卷内对决: 与血神教主的终极战斗（步骤19）
  - 卷内自我揭示: 理解力量的真谛（步骤20）
  - 卷内新平衡: 飞升仙界，留续集接口（步骤22）
```
...
1. **至少标注 4 个关键节点**：虚假自我/欲望（起点）、对手（冲突源）、表面失败（低谷）、对决/新平衡（高潮+收束）
2. **全书 22 步不要求每卷都覆盖**：不同卷侧重不同步骤，整体覆盖即可
3. **步骤之间要有递进**：第一卷的"表面失败"应比第二卷的轻，层层加重
4. **对手要有递进**：每卷的对手应比上一卷更强/更深，体现主角成长

| 推荐每卷至少标注 | 步骤 | 说明 |
|----------------|------|------|
| 卷内起点 | 1-2（虚假自我/欲望） | 本卷的初始状态和阶段目标 |
| 卷内对手 | 3（对手） | 本卷的主要对立力量 |
| 卷内计划 | 4（计划） | 主角在本卷的行动策略 |
| 卷内低谷 | 15（表面失败） | 本卷的情感最低点 |
| 卷内高潮 | 19（对决） | 本卷的终极对抗 |
| 卷内收束 | 22（新平衡） | 本卷的结果 + 下卷的伏笔 |
