...
详见 [v2.8-data-boundaries.md](./v2.8-data-boundaries.md) 主矩阵。
...
现状 `id === name` 为 **LEGACY**；Phase C 迁移须重分配 id。详见 [v2.8-entity-identity.md](./v2.8-entity-identity.md)。
...
| **V2.8** ✅ / 🚧 | Schema：`current_state_ref`、`planner_order`、agents 拆分；**Creative Center 运营层收敛** | conventions.js；§十二 + `roadmap-v2.8-creative-center.md` |
...
> **权威细节**：[v2.8-creative-cockpit-architecture.md](./v2.8-creative-cockpit-architecture.md)  
...
路线图：[roadmap-v2.8-creative-center.md](./roadmap-v2.8-creative-center.md)（P2=目标架构 ✅，P3 数据边界，P4 迁移，P5 UI）。
...
- [v2.8-creative-cockpit-architecture.md](./v2.8-creative-cockpit-architecture.md) — **Creative Center 目标架构（权威）**
- [v2.8-data-boundaries.md](./v2.8-data-boundaries.md) — **P3 数据边界白皮书（权威）**
- [v2.8-measurement-layer.md](./v2.8-measurement-layer.md) — **Measurement Layer（Review/Verify/Health 关系）**
- [v2.8-entity-identity.md](./v2.8-entity-identity.md) — **Entity Identity Law（Phase C 前门）**
- [v2.8-legacy-inventory.md](./v2.8-legacy-inventory.md) — **Legacy Inventory（现实审计）**
- [v2.8-migration-design.md](./v2.8-migration-design.md) — **Migration Design（Phase C / Dry Run 依据）**
- [roadmap-v2.8-creative-center.md](./roadmap-v2.8-creative-center.md) — 分阶段实施路线图
